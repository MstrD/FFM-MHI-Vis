function drawParallel(data) {
    ...
    dimensions = ["Neuroticismo_NEOFFI", "Extroversão_NEOFFI", "AberturaExperiência_NEOFFI",
                  "AmabIilidade_NEOFFI", "Conscienciosidade_NEOFFI"];
  
    dimensions_name = ["Neuroticism", "Extraversion", "Openness", "Agreeableness", "Conscientiousness"];
